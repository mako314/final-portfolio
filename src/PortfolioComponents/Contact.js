            ...
            <div className="lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="#88BDBC" strokeWidth="2">
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <a href="https://github.com/mako314" aria-label="Homepage" className="footer-octicon" title="GitHub">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#88BDBC" className="bi bi-github ml-2" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.linkedin.com/in/macolister/"> 
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#88BDBC" className="bi bi-linkedin ml-4" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.discordapp.com/users/1108126068226916393">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#88BDBC" className="bi bi-discord ml-4" viewBox="0 0 16 16">
