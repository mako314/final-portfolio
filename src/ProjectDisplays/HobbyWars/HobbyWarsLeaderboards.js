        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full group cursor-pointer"> {/* Parent container for image and overlay */}
            <div className="relative shadow-lg"> {/* This div becomes the relative container */}
              ...
              <div onClick={() => openModal(HobbyWarsLeaderBoardsImage, "Hobby Wars Leaderboards Page", "Hobby Wars Leader Boards")} className="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center group-hover:opacity-100 opacity-0 transition-opacity">
          ...
          {selectedImage?.src && (
                ...
                <div className={`relative rounded-lg bg-${theme === 'dark' ? 'gray-800' : 'bg-gray-100'} max-w-7xl max-h-full overflow-auto p-6`} onClick={handleModalContentClick}>
