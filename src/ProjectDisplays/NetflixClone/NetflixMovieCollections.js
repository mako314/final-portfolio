...
function NetflixMovieCollections({
  ...
  return (
    <section className="text-gray-600 body-font overflow-hidden">
      ...
      <button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Back to Projects
      </button>                 
      </a>
    </section>
  );
